def run_pixel(ctx, out):
    ...
    def getVert__int_int(zoneIdx, vertIdx):
        ...
        return (rt.swizzle(packed, "xy") if rt.binary("==", rt.binary("%", vertIdx, rt.i(2), 1, "int"), rt.i(0)) else rt.swizzle(packed, "zw"))
    ...
    def distToZoneEdge__vec2_int(p, zoneIdx):
        ...
        for _for1 in range(1048576):
            ...
            len2 = rt.component_wise("max", rt.dot(ab, ab), rt.f(1e-09), width=1)
    ...
    def main__void():
        ...
        for _for2 in range(1048576):
            ...
            if rt.binary("==", getZoneActive__int(z), rt.i(0)):
                continue
            if (not (pointInZone__vec2_int(p, z))):
                continue
