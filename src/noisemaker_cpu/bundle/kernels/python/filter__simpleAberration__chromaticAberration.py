def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        redGlobalUV = rt.binary("+", globalUV, rt.array([boundedDisplacement, rt.f(0.0)]), 2, "float")
        ...
        blueGlobalUV = rt.binary("-", globalUV, rt.array([boundedDisplacement, rt.f(0.0)]), 2, "float")
