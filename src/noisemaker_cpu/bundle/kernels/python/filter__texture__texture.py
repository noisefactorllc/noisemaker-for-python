def run_pixel(ctx, out):
    ...
    def material_gradient_layer__vec2_uint_uint(p, salt, layer):
        ...
        n10 = rt.dot(material_gradient__ivec2_uint_uint(rt.binary("+", cell, rt.construct(2, rt.i(1), rt.i(0), base="int"), 2, "int"), salt, layer), rt.binary("-", local, rt.array([rt.f(1.0), rt.f(0.0)]), 2, "float"))
        n01 = rt.dot(material_gradient__ivec2_uint_uint(rt.binary("+", cell, rt.construct(2, rt.i(0), rt.i(1), base="int"), 2, "int"), salt, layer), rt.binary("-", local, rt.array([rt.f(0.0), rt.f(1.0)]), 2, "float"))
        n11 = rt.dot(material_gradient__ivec2_uint_uint(rt.binary("+", cell, rt.construct(2, rt.i(1), rt.i(1), base="int"), 2, "int"), salt, layer), rt.binary("-", local, rt.f(1.0), 2, "float"))
    ...
    def material_soft__vec2_float_uint_float(globalPixel, motion, salt, size):
        ...
        secondary = material_noise__vec2_vec2_float_uint(rt.binary("+", globalPixel, rt.array([rt.f(17.31), rt.f(29.17)]), 2, "float"), rt.binary("*", primaryCell, rt.f(1.87), 2, "float"), rt.binary("+", motion, rt.f(0.41), 1, "float"), rt.binary("^", salt, rt.i(1757159915), 1, "uint"))
    ...
    def material_directional__vec2_float_uint_float(globalPixel, motion, salt, size):
        ...
        primary = material_noise__vec2_vec2_float_uint(globalPixel, primaryCell, motion, salt)
        secondary = material_noise__vec2_vec2_float_uint(rt.binary("+", globalPixel, rt.array([rt.f(19.37), rt.f(11.83)]), 2, "float"), secondaryCell, rt.binary("+", motion, rt.f(0.41), 1, "float"), rt.binary("^", salt, rt.i(1757159915), 1, "uint"))
    ...
    def material_sprinkles__vec2_float_uint_float(globalPixel, motion, salt, size):
        globalPixel = rt.copy(globalPixel, "float")
        p = rt.binary("+", rt.binary("/", globalPixel, rt.component_wise("max", rt.binary("*", rt.f(4.0), size, 1, "float"), rt.f(1.0), width=1), 2, "float"), rt.array([rt.binary("*", motion, rt.f(0.31), 1, "float"), rt.binary("*", motion, rt.f(0.19), 1, "float")]), 2, "float")
    ...
    def material_edge_mask__vec2_vec2(uv, pixelStep):
        ...
        l = rt.dot(rt.swizzle(rt.texture(_u_inputTex, rt.binary("-", uv, rt.array([rt.swizzle(pixelStep, "x"), rt.f(0.0)]), 2, "float")), "rgb"), rt.construct(3, rt.f(0.2126), rt.f(0.7152), rt.f(0.0722)))
        r = rt.dot(rt.swizzle(rt.texture(_u_inputTex, rt.binary("+", uv, rt.array([rt.swizzle(pixelStep, "x"), rt.f(0.0)]), 2, "float")), "rgb"), rt.construct(3, rt.f(0.2126), rt.f(0.7152), rt.f(0.0722)))
        d = rt.dot(rt.swizzle(rt.texture(_u_inputTex, rt.binary("-", uv, rt.array([rt.f(0.0), rt.swizzle(pixelStep, "y")]), 2, "float")), "rgb"), rt.construct(3, rt.f(0.2126), rt.f(0.7152), rt.f(0.0722)))
        u = rt.dot(rt.swizzle(rt.texture(_u_inputTex, rt.binary("+", uv, rt.array([rt.f(0.0), rt.swizzle(pixelStep, "y")]), 2, "float")), "rgb"), rt.construct(3, rt.f(0.2126), rt.f(0.7152), rt.f(0.0722)))
    ...
    def main__void():
        ...
        h_right = height_field__vec2_vec2_float(rt.binary("+", ctx.uv, rt.array([rt.swizzle(pixel_step, "x"), rt.f(0.0)]), 2, "float"), base_freq, motion)
        h_left = height_field__vec2_vec2_float(rt.binary("-", ctx.uv, rt.array([rt.swizzle(pixel_step, "x"), rt.f(0.0)]), 2, "float"), base_freq, motion)
        h_up = height_field__vec2_vec2_float(rt.binary("+", ctx.uv, rt.array([rt.f(0.0), rt.swizzle(pixel_step, "y")]), 2, "float"), base_freq, motion)
        h_down = height_field__vec2_vec2_float(rt.binary("-", ctx.uv, rt.array([rt.f(0.0), rt.swizzle(pixel_step, "y")]), 2, "float"), base_freq, motion)
