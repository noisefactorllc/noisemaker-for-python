def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        flare[:] = rt.binary("+", flare, rt.construct(3, coreGlow__float(d0)), 3, "float")
        streakVal = anamorphicStreak__vec2(delta0)
        if rt.binary("==", _u_LENS_TYPE, rt.i(3)):
            streakVal = rt.binary("*", streakVal, rt.f(2.0), 1, "float")
        flare[:] = rt.binary("+", flare, rt.construct(3, streakVal), 3, "float")
        ...
        if (bool(rt.binary("==", _u_LENS_TYPE, rt.i(0))) or bool(rt.binary("==", _u_LENS_TYPE, rt.i(3)))):
            ...
            flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(1.0), rt.f(0.85), rt.f(0.6)), circleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.06)), 3, "float"), rt.f(0.35), 3, "float"), 3, "float")
            _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.4), aspectRatio)
            flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.4), rt.f(0.9), rt.f(0.85)), circleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.1)), 3, "float"), rt.f(0.25), 3, "float"), 3, "float")
            _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.6), aspectRatio)
            flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.65), rt.f(0.4), rt.f(0.95)), circleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.045)), 3, "float"), rt.f(0.45), 3, "float"), 3, "float")
            _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.85), aspectRatio)
            flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.45), rt.f(0.9), rt.f(0.5)), circleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.14)), 3, "float"), rt.f(0.18), 3, "float"), 3, "float")
            _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(1.2), aspectRatio)
            flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(1.0), rt.f(0.55), rt.f(0.2)), circleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.08)), 3, "float"), rt.f(0.3), 3, "float"), 3, "float")
            _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(1.55), aspectRatio)
            flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.4), rt.f(0.55), rt.f(1.0)), ringGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.2)), 3, "float"), rt.f(0.12), 3, "float"), 3, "float")
        else:
            if rt.binary("==", _u_LENS_TYPE, rt.i(1)):
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.3), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(1.0), rt.f(0.8), rt.f(0.55)), hexGhost__vec2_float(rt.binary("-", p, _g, 2, "float"), rt.f(0.04)), 3, "float"), rt.f(0.35), 3, "float"), 3, "float")
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.55), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.85), rt.f(0.85), rt.f(0.92)), hexGhost__vec2_float(rt.binary("-", p, _g, 2, "float"), rt.f(0.055)), 3, "float"), rt.f(0.3), 3, "float"), 3, "float")
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.8), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.95), rt.f(0.7), rt.f(0.5)), hexGhost__vec2_float(rt.binary("-", p, _g, 2, "float"), rt.f(0.065)), 3, "float"), rt.f(0.25), 3, "float"), 3, "float")
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(1.3), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.8), rt.f(0.85), rt.f(0.95)), hexGhost__vec2_float(rt.binary("-", p, _g, 2, "float"), rt.f(0.08)), 3, "float"), rt.f(0.2), 3, "float"), 3, "float")
            else:
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.45), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.92), rt.f(0.85), rt.f(0.78)), softCircleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.12)), 3, "float"), rt.f(0.25), 3, "float"), 3, "float")
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(0.9), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.85), rt.f(0.88), rt.f(0.95)), softCircleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.16)), 3, "float"), rt.f(0.2), 3, "float"), 3, "float")
                _g[:] = flareAxis__vec2_vec2_float_float(flarePos, mirrorPos, rt.f(1.5), aspectRatio)
                flare[:] = rt.binary("+", flare, rt.binary("*", rt.binary("*", rt.construct(3, rt.f(0.95), rt.f(0.88), rt.f(0.8)), softCircleGhost__float_float(rt.length(rt.binary("-", p, _g, 2, "float")), rt.f(0.2)), 3, "float"), rt.f(0.15), 3, "float"), 3, "float")
        outFlare = rt.binary("*", rt.binary("*", flare, _u_tint, 3, "float"), rt.binary("/", _u_brightness, rt.f(100.0), 1, "float"), 3, "float")
        if rt.binary("==", _u_LENS_TYPE, rt.i(3)):
            outFlare[:] = rt.binary("*", outFlare, rt.construct(3, rt.f(0.9), rt.f(0.95), rt.f(1.1)), 3, "float")
