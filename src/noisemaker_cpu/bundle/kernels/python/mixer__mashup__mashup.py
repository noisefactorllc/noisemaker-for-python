def run_pixel(ctx, out):
    ...
    _u_layer0_active = U.get("layer0_active", 0)
    _u_layer1_active = U.get("layer1_active", 0)
    _u_layer2_active = U.get("layer2_active", 0)
    _u_layer3_active = U.get("layer3_active", 0)
    _u_layer4_active = U.get("layer4_active", 0)
    _u_layer5_active = U.get("layer5_active", 0)
    _u_layer6_active = U.get("layer6_active", 0)
    _u_layer7_active = U.get("layer7_active", 0)
