def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        h = rt.component_wise("clamp", rt.binary("/", _u_hardness, rt.f(100.0), 1, "float"), rt.f(0.0), rt.f(0.995), width=1)
        width = rt.binary("*", rt.binary("-", rt.f(1.0), h, 1, "float"), rt.f(0.5), 1, "float")
        mask = rt.component_wise("smoothstep", rt.binary("-", rt.f(0.5), width, 1, "float"), rt.binary("+", rt.f(0.5), width, 1, "float"), mask, width=1)
        f_low = rt.component_wise("clamp", rt.binary("/", rt.binary("+", _u_power, rt.f(100.0), 1, "float"), rt.f(5.0), 1, "float"), rt.f(0.0), rt.f(1.0), width=1)
        f_high = rt.component_wise("clamp", rt.binary("/", rt.binary("-", rt.f(100.0), _u_power, 1, "float"), rt.f(5.0), 1, "float"), rt.f(0.0), rt.f(1.0), width=1)
