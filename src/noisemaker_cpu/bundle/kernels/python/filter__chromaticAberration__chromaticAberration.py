def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        blueOffset = rt.component_wise("mix", rt.swizzle(uv, "x"), rt.component_wise("clamp", rt.binary("-", rt.swizzle(uv, "x"), aberrationOffset, 1, "float"), rt.f(0.0), rt.f(1.0), width=1), rt.swizzle(uv, "x"), width=1)
