def run_pixel(ctx, out):
    ...
    def curlNoise3D__vec3(p):
        ...
        Fx_py = fbmSimplex3D__vec3(rt.binary("-", rt.binary("+", p, rt.array([rt.f(0.0), eps, rt.f(0.0)]), 3, "float"), offset1, 3, "float"))
        Fx_ny = fbmSimplex3D__vec3(rt.binary("+", rt.binary("-", p, rt.array([rt.f(0.0), eps, rt.f(0.0)]), 3, "float"), offset1, 3, "float"))
        Fx_pz = fbmSimplex3D__vec3(rt.binary("-", rt.binary("+", p, rt.array([rt.f(0.0), rt.f(0.0), eps]), 3, "float"), offset1, 3, "float"))
        Fx_nz = fbmSimplex3D__vec3(rt.binary("+", rt.binary("-", p, rt.array([rt.f(0.0), rt.f(0.0), eps]), 3, "float"), offset1, 3, "float"))
        Fy_px = fbmSimplex3D__vec3(rt.binary("-", rt.binary("+", p, rt.array([eps, rt.f(0.0), rt.f(0.0)]), 3, "float"), offset2, 3, "float"))
        Fy_nx = fbmSimplex3D__vec3(rt.binary("+", rt.binary("-", p, rt.array([eps, rt.f(0.0), rt.f(0.0)]), 3, "float"), offset2, 3, "float"))
        Fy_pz = fbmSimplex3D__vec3(rt.binary("-", rt.binary("+", p, rt.array([rt.f(0.0), rt.f(0.0), eps]), 3, "float"), offset2, 3, "float"))
        Fy_nz = fbmSimplex3D__vec3(rt.binary("+", rt.binary("-", p, rt.array([rt.f(0.0), rt.f(0.0), eps]), 3, "float"), offset2, 3, "float"))
        Fz_px = fbmSimplex3D__vec3(rt.binary("-", rt.binary("+", p, rt.array([eps, rt.f(0.0), rt.f(0.0)]), 3, "float"), offset3, 3, "float"))
        Fz_nx = fbmSimplex3D__vec3(rt.binary("+", rt.binary("-", p, rt.array([eps, rt.f(0.0), rt.f(0.0)]), 3, "float"), offset3, 3, "float"))
        Fz_py = fbmSimplex3D__vec3(rt.binary("-", rt.binary("+", p, rt.array([rt.f(0.0), eps, rt.f(0.0)]), 3, "float"), offset3, 3, "float"))
        Fz_ny = fbmSimplex3D__vec3(rt.binary("+", rt.binary("-", p, rt.array([rt.f(0.0), eps, rt.f(0.0)]), 3, "float"), offset3, 3, "float"))
    ...
    def main__void():
        ...
        centered = rt.binary("*", rt.binary("-", uv, rt.f(0.5), 2, "float"), rt.array([aspect, rt.f(1.0)]), 2, "float")
