def run_pixel(ctx, out):
    ...
    def compute_lens_offsets__vec2_float_float_vec2_float_float_float(sample_pos, width, height, freq, time, speed, displacement):
        ...
        uv_centered = rt.binary("/", rt.binary("+", wrapped_pos, rt.f(0.5), 2, "float"), rt.array([width_safe, height_safe]), 2, "float")
        ...
        offsets = rt.binary("*", rt.binary("*", rt.construct(2, rt.component_wise("cos", angle, width=1), rt.component_wise("sin", angle, width=1)), displacement, 2, "float"), rt.array([width_safe, height_safe]), 2, "float")
        return offsets
