def run_pixel(ctx, out):
    ...
    def valueNoise__vec3(p):
        ...
        c100 = hashNoise__vec3(rt.binary("+", i, rt.array([rt.f(1.0), rt.f(0.0), rt.f(0.0)]), 3, "float"))
        c010 = hashNoise__vec3(rt.binary("+", i, rt.array([rt.f(0.0), rt.f(1.0), rt.f(0.0)]), 3, "float"))
        c110 = hashNoise__vec3(rt.binary("+", i, rt.array([rt.f(1.0), rt.f(1.0), rt.f(0.0)]), 3, "float"))
        c001 = hashNoise__vec3(rt.binary("+", i, rt.array([rt.f(0.0), rt.f(0.0), rt.f(1.0)]), 3, "float"))
        c101 = hashNoise__vec3(rt.binary("+", i, rt.array([rt.f(1.0), rt.f(0.0), rt.f(1.0)]), 3, "float"))
        c011 = hashNoise__vec3(rt.binary("+", i, rt.array([rt.f(0.0), rt.f(1.0), rt.f(1.0)]), 3, "float"))
        c111 = hashNoise__vec3(rt.binary("+", i, rt.f(1.0), 3, "float"))
