                ...
                if rt.binary("==", _u_smoothing, rt.i(4)):
                    ...
                    if rt.binary("==", _u_smoothing, rt.i(5)):
                        ...
                        if rt.binary("==", _u_smoothing, rt.i(6)):
                            ...
                            v10 = rt.swizzle(rt.texture(_u_fbTex, rt.binary("/", rt.binary("+", xy, rt.construct(2, rt.swizzle(nd2, "x"), rt.f(0.0)), 2, "float"), _u_fullResolution, 2, "float")), "g")
                            v01 = rt.swizzle(rt.texture(_u_fbTex, rt.binary("/", rt.binary("+", xy, rt.construct(2, rt.f(0.0), rt.swizzle(nd2, "y")), 2, "float"), _u_fullResolution, 2, "float")), "g")
