def run_pixel(ctx, out):
    ...
    def noise3d__vec3(p):
        ...
        n000 = hash31__vec3(i)
        n100 = hash31__vec3(rt.binary("+", i, rt.array([rt.f(1.0), rt.f(0.0), rt.f(0.0)]), 3, "float"))
        n010 = hash31__vec3(rt.binary("+", i, rt.array([rt.f(0.0), rt.f(1.0), rt.f(0.0)]), 3, "float"))
        n110 = hash31__vec3(rt.binary("+", i, rt.array([rt.f(1.0), rt.f(1.0), rt.f(0.0)]), 3, "float"))
        n001 = hash31__vec3(rt.binary("+", i, rt.array([rt.f(0.0), rt.f(0.0), rt.f(1.0)]), 3, "float"))
        n101 = hash31__vec3(rt.binary("+", i, rt.array([rt.f(1.0), rt.f(0.0), rt.f(1.0)]), 3, "float"))
        n011 = hash31__vec3(rt.binary("+", i, rt.array([rt.f(0.0), rt.f(1.0), rt.f(1.0)]), 3, "float"))
        n111 = hash31__vec3(rt.binary("+", i, rt.f(1.0), 3, "float"))
