def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        shadeFactor = rt.component_wise("mix", rt.f(1.0), rt.binary("+", rt.f(0.5), rt.binary("*", rt.f(0.5), diffuse, 1, "float"), 1, "float"), _u_strength, width=1)
        ...
        inv_factor = rt.binary("/", rt.f(1.0), lev, 1, "float")
