def run_pixel(ctx, out):
    ...
    def outputNormalMap__vec2_vec2_vec2_float_float_int_float(fragCoord, cX_df, cY_df, z_zoom, rot, maxIter, angle):
        ...
        hx = computeValueAt_df64__vec2_vec2_vec2_float_float_int(rt.binary("+", fragCoord, rt.array([rt.f(1.0), rt.f(0.0)]), 2, "float"), cX_df, cY_df, z_zoom, rot, maxIter)
        hy = computeValueAt_df64__vec2_vec2_vec2_float_float_int(rt.binary("+", fragCoord, rt.array([rt.f(0.0), rt.f(1.0)]), 2, "float"), cX_df, cY_df, z_zoom, rot, maxIter)
