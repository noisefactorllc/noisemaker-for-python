def run_pixel(ctx, out):
    ...
    def hash22__vec2(p):
        p = rt.copy(p)
        p3 = rt.component_wise("fract", rt.binary("*", rt.construct(3, rt.swizzle(p, "xyx")), rt.construct(3, rt.f(0.1031), rt.f(0.1030), rt.f(0.0973)), 3, "float"), width=3)
    ...
    def main__void():
        ...
        rnd = rt.binary("-", hash22__vec2(rt.binary("+", hashCoord, rt.binary("*", _u_seed, rt.f(101.7), 1, "float"), 2, "float")), rt.f(0.5), 2, "float")
