    ...
    def main__void():
        ...
        if rt.binary("==", _u_SHAPE, rt.i(1)):
            ...
            for _for0 in range(1048576):
                ...
                for _for1 in range(1048576):
                    ...
                    if rt.binary("&&", rt.binary("==", x, rt.i(0)), rt.binary("==", y, rt.i(0))):
                        continue
                    d = rt.construct(2, x, y)
                    if rt.binary(">", rt.dot(d, d), r2):
                        continue
                    s = rt.texture(_u_inputTex, rt.binary("+", uv, rt.binary("*", d, texel, 2), 2))
            ...
            for _for2 in range(1048576):
                ...
                if rt.binary(">", i, r):
                    break
                o = rt.binary("*", rt.construct(2, i, rt.f(0.0)), texel, 2)
                sL = rt.texture(_u_inputTex, rt.binary("-", uv, o, 2))
                sR = rt.texture(_u_inputTex, rt.binary("+", uv, o, 2))
