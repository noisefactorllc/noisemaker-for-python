def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        c10 = rt.texture(_u_inputTex, rt.component_wise("fract", rt.binary("+", st, rt.array([rt.f(0.5), rt.f(0.0)]), 2, "float"), width=2))
        c01 = rt.texture(_u_inputTex, rt.component_wise("fract", rt.binary("+", st, rt.array([rt.f(0.0), rt.f(0.5)]), 2, "float"), width=2))
        c11 = rt.texture(_u_inputTex, rt.component_wise("fract", rt.binary("+", st, rt.f(0.5), 2, "float"), width=2))
