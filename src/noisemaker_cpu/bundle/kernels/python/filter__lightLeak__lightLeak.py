def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        base_dist = rt.f(0.0)
        (((_retc0 := voronoiCell__vec2_float_float_vec3_float(uv, seed_f, t, base_cell, base_dist)), base_cell.__setitem__(slice(None), _retc0[1]), (base_dist := _retc0[2]), _retc0[0])[-1])
        ...
        warp_dist = rt.f(0.0)
        (((_retc1 := voronoiCell__vec2_float_float_vec3_float(warped_uv, seed_f, t, warp_cell, warp_dist)), warp_cell.__setitem__(slice(None), _retc1[1]), (warp_dist := _retc1[2]), _retc1[0])[-1])
