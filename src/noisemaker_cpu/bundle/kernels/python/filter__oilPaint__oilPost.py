def run_pixel(ctx, out):
    ...
    def lumGradientFlat__vec2(uv):
        ...
        tl = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.array([rt.unary("-", rt.f(1.0)), rt.f(1.0)]), 2, "float"), 2, "float")), "rgb"))
        l = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.array([rt.unary("-", rt.f(1.0)), rt.f(0.0)]), 2, "float"), 2, "float")), "rgb"))
        bl = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.unary("-", rt.f(1.0)), 2, "float"), 2, "float")), "rgb"))
        tr = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.f(1.0), 2, "float"), 2, "float")), "rgb"))
        r = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.array([rt.f(1.0), rt.f(0.0)]), 2, "float"), 2, "float")), "rgb"))
        br = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.array([rt.f(1.0), rt.unary("-", rt.f(1.0))]), 2, "float"), 2, "float")), "rgb"))
        t = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.array([rt.f(0.0), rt.f(1.0)]), 2, "float"), 2, "float")), "rgb"))
        b = lum__vec3(rt.swizzle(rt.texture(_u_flatTex, rt.binary("+", uv, rt.binary("*", px, rt.array([rt.f(0.0), rt.unary("-", rt.f(1.0))]), 2, "float"), 2, "float")), "rgb"))
