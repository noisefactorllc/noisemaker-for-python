def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        dxp = rt.swizzle(cellNoise3D__vec3(rt.binary("+", scaledP, rt.array([eps, rt.f(0.0), rt.f(0.0)]), 3, "float")), "x")
        dyp = rt.swizzle(cellNoise3D__vec3(rt.binary("+", scaledP, rt.array([rt.f(0.0), eps, rt.f(0.0)]), 3, "float")), "x")
        dzp = rt.swizzle(cellNoise3D__vec3(rt.binary("+", scaledP, rt.array([rt.f(0.0), rt.f(0.0), eps]), 3, "float")), "x")
