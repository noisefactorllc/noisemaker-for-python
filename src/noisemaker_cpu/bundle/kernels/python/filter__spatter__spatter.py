def run_pixel(ctx, out):
    ...
    def main__void():
        ...
        nUV = rt.binary("*", globalUV, rt.array([aspect, rt.f(1.0)]), 2, "float")
        ...
        warpX = bilinearExpGrid__vec2_uint(rt.binary("*", nUV, rt.array([warpFreqX, warpFreqY]), 2, "float"), rt.binary("+", s, rt.i(200), 1, "uint"))
        warpY = bilinearExpGrid__vec2_uint(rt.binary("*", nUV, rt.array([warpFreqX, warpFreqY]), 2, "float"), rt.binary("+", s, rt.i(300), 1, "uint"))
